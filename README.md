...
El proyecto tiene una base sólida. El Ciclo 1 está completamente desarrollado, integrando detalles de calidad como la escala métrica y el sistema dinámico de colores. El Ciclo 2 aún no ha iniciado formalmente; aunque el avance en el primer bloque está finalizado, el tiempo se agotó y se darán los avances necesarios próximamente para estar al día.
...
Completar el primer ciclo con éxito y ver el correcto funcionamiento de la aplicación de los objetos con los requerimientos, asegurando que toda la lógica se traduzca en una respuesta exacta en la torre.

5. ¿Cuál consideran que fue el mayor problema técnico?
El algoritmo de apilamiento y la unificación de los objetos. Lograr que tazas y tapas se reconocieran y respetaran los espacios físicos fue un reto lógico constante. Se resolvió mediante investigación en foros, tutoriales y apoyo en herramientas de IA para el manejo de colecciones.
